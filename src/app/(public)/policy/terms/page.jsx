...
export default function TermsOfService() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#090D14] text-gray-800 dark:text-gray-200 selection:bg-blue-500/30">
      ...
      <div className="relative py-28 bg-brand-dark overflow-hidden border-b border-white/5 shadow-2xl">
        ...
        <div className="max-w-5xl mx-auto px-6 lg:px-8 relative z-10">
          ...
          <p className="text-lg md:text-xl text-gray-400 max-w-3xl leading-relaxed">
            These terms serve as the guiding principles and operational regulations regarding the management of your relationship with us.
          </p>
        </div>
      </div>
            ...
            <div className="sticky top-12 space-y-4">
              ...
              <ul className="space-y-3">
                {sections.map((section, idx) => (
                  <li key={idx}>
                    <a href={`#section-${idx}`} className="text-sm text-gray-600 dark:text-gray-400 hover:text-blue-500 transition-colors">
                      {section.title}
                    </a>
                  </li>
                ))}
