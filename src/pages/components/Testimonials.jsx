          ...
          <ul className="flex items-center justify-center md:justify-start [&_li]:mx-4 [&_img]:max-w-none animate-marquee">
            ...
            {[...testimonials, ...testimonials].map((item, idx) => (
              <li key={idx} className="w-[350px] md:w-[450px] flex-shrink-0">
                <div className="h-full bg-brand-dark-lighter/30 backdrop-blur-md border border-brand-dark-lighter/50 p-8 rounded-2xl relative group hover:border-brand-primary/30 transition-all duration-300">
                  {/* Quote Icon */}
                  <div className="absolute top-8 right-8 text-brand-dark-lighter/50 group-hover:text-brand-primary/20 transition-colors duration-300">
                    <FaQuoteLeft size={32} />
                  </div>
                  ...
                  <p className="text-brand-text-muted text-lg leading-relaxed mb-8 relative z-10 min-h-[100px]">
                    "{item.quote}"
                  </p>

                  <div className="mt-auto border-t border-brand-dark-lighter/50 pt-4">
