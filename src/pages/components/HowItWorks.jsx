            ...
            <Slide key={idx} delay={idx * 0.15} xAxis={50}>
              <div className="relative group">
                ...
                <div className="relative z-10 flex flex-col items-center text-center">
                  <div className="w-20 h-20 rounded-2xl bg-brand-dark-lighter border border-brand-primary/20 flex items-center justify-center text-brand-primary mb-6 shadow-lg shadow-brand-primary/5 group-hover:scale-110 group-hover:border-brand-primary/50 transition-all duration-300">
                    {step.icon}
                  </div>
                  ...
                  <p className="text-brand-text-muted text-sm leading-relaxed max-w-[250px]">
                    {step.desc}
                  </p>
                </div>
              </div>
