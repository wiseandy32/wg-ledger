...
import institutionalSecurity from "../assets/institutional_security.png"; // Reusing the asset from Login if appropriate, or maybe about-image-2.avif
import aboutImage from "../assets/about-image-2.avif";
    ...
    <div className="bg-brand-dark min-h-screen relative overflow-hidden pt-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 mb-32">
          ...
          >
            <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-brand-dark-lighter/50 group">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
              <div className="p-6 rounded-2xl bg-brand-dark-lighter/30 border border-brand-dark-lighter/50 backdrop-blur-sm">
                <h3 className="text-white font-bold text-xl mb-2">3.5B+</h3>
                <p className="text-sm text-brand-text-muted">Assets Secured</p>
              </div>
              <div className="p-6 rounded-2xl bg-brand-dark-lighter/30 border border-brand-dark-lighter/50 backdrop-blur-sm">
                <h3 className="text-white font-bold text-xl mb-2">120+</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          {features.map((feature, idx) => (
            <motion.div
              ...
              className="p-8 rounded-3xl bg-brand-dark-lighter/20 border border-brand-dark-lighter/50 hover:border-brand-primary/30 transition-all hover:-translate-y-2"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5, delay: idx * 0.1 }}
                className="p-6 rounded-2xl bg-brand-dark-lighter/10 border border-brand-dark-lighter/30 hover:bg-brand-dark-lighter/20 hover:border-brand-primary/20 transition-all text-center group"
              >
                <div className="w-2 h-2 rounded-full bg-brand-primary mx-auto mb-4 group-hover:scale-150 transition-transform"></div>
                <h3 className="text-lg font-bold text-white mb-2">
                  {val.title}
                </h3>
                <p className="text-sm text-brand-text-muted">{val.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
        ...
        {/* The Foundation (Lore) */}
        <div className="relative rounded-3xl overflow-hidden bg-brand-dark-lighter/20 border border-brand-dark-lighter/40 p-8 md:p-16 text-center mb-20">
          ...
          >
            ...
            <p className="text-lg text-brand-text-muted max-w-4xl mx-auto leading-relaxed mb-8">
