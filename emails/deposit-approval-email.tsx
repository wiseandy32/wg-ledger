...
> = ({ name, amount, coin, transactionReference, date }) => (
  <Html>
    <Head />
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={content}>
          ...
          <Text style={text}>
            Your recent deposit has been approved and the funds are now
            available in your account. Below are the details of the transaction:
          </Text>
          <table style={table}>
            <tbody>
              <tr style={tableRow}>
